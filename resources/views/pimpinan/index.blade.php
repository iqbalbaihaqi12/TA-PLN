            ...
            <div class="card shadow mb-4">
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  ...
                  <button type="button" class="d-none d-sm-inline-block btn btn-sm btn-primary float-right shadow-sm"><i class="fas fa-download fa-sm text-white-50">  </i> Export</button>
                </div>
