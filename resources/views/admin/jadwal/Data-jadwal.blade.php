            ...
            <div class="col-xl-12 col-lg-12">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Jadwal Inspeksi</h6>
                </div>

                <div class="card-body">
                <a href="/admin/create-jadwal"  class="btn btn-primary float-right btn-sm"><i class="fas fa-plus"></i>  Tambah Jadwal</a>
...
<a href="{{url('/admin/edit-jadwal',$item->id)}}"><i class="fas fa-edit" style="color: blue"></i></a> |
<a href="{{url('/admin/hapus-jadwal',$item->id)}}"><i class="fas fa-trash-alt" style="color: red">
