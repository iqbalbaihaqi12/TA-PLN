        ...
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <!-- <div class="card shadow mb-4">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Edit Jadwal Inspeksi</h6>
                </div>

                <div class="card-body">
                    <form action="{{url('/admin/update-jadwal',$jadwal->id)}}" method="post">
                    {{ csrf_field() }}

                    <div class="form-group">

                    <input type="date" class="form-control" name="tanggal" aria-describedby=""  placeholder="Tanggal" value="{{$jadwal->tanggal}}">

                    </div>
                    <div class="form-group">
                        <input type="text" class="form-control" name="penyulang" placeholder="Penyulang" value="{{$jadwal->penyulang}}">
                    </div>
