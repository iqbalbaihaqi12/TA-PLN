...
<body id="page-top">
          ...
          <div class="row">
            ...
            <!-- <div class="card shadow mb-4">
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form action="{{route('simpan-hasiltemuan')}}" method="post" enctype="multipart/form-data">
                    {{ csrf_field() }}
  ...
  <select class="custom-select" id="inputGroupSelect01" name="kategori">
    ...
    <option value="2">Inspeksi Instalasi Tenaga Listrik</option>
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" name="koordinat" placeholder="Koordinat">
                    </div>
                    <div class="form-group">
                        <input type="text" class="form-control" name="potensi" placeholder="Potensi Bahaya">
                    </div>
                    <div class="form-group">
