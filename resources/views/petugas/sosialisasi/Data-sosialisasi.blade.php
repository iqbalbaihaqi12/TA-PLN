...
<body id="page-top">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <!-- <div class="card shadow mb-4">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Sosialisasi</h6>
                </div>

                <div class="card-body">
                <a href="/petugas/create-sosialisasi"  class="btn btn-primary float-right btn-sm"><i class="fas fa-plus"></i>  Tambah Hasil Sosialisasi</a>
  ...
  <tbody>
      <tr>
        ...
        <td>{{$item->detail}}</td>
        <td> <img src="{{asset('image/'.$item->evidence)}}" height="10%" width="30%" alt="" srcset=""></td>
